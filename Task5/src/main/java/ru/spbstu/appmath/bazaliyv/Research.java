...
public class Research {
    ...
    private static void doResearch(String firstMatrix, String secondMatrix, String report) throws IOException {
        int threads = 1;
        ...
        for (threads = 1; threads <= 1000; threads *= 10) {
            MultiplyMatrix multiplyMatrix = new MultiplyMatrix(A,B,threads);
